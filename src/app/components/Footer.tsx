  ...
  return (
    <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10">
      ...
      <nav>
        ...
        <a className="link link-hover">{t('Footer.services.trip')}</a>
      </nav>
      <nav>
        <h6 className="footer-title">{t('Footer.company.title')}</h6>
        <a className="link link-hover">{t('Footer.company.about')}</a>
        <a className="link link-hover">{t('Footer.company.trips')}</a>
        <a className="link link-hover">{t('Footer.company.book')}</a>
        <a className="link link-hover">{t('Footer.company.blog')}</a>
      </nav>
      <nav>
